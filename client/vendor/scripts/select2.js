...
(function($, undefined) {
    ...
    $(document)
        .ready(function() {
        $(document)
            .delegate("*", "mousedown touchend", function(e) {
            var target = $(e.target)
                .closest("div.select2-container")
                .get(0),
                attr;
            if (target) {
                $(document)
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function(opts) {
            ...
            this.dropdown.delegate(resultsSelector, "mouseup", this.bind(function(e) {
                if ($(e.target)
                    .closest(".select2-result-selectable:not(.select2-disabled)")
                    .length > 0) {
        ...
        close: function() {
            ...
            this.container.parents()
                .each(function() {
                $(this)
                    .unbind("scroll." + self.containerId);
            });
            $(window)
                .unbind("resize." + this.containerId);
        ...
        ensureHighlightVisible: function() {
            ...
            if (index === children.length - 1) {
                ...
                if (more.length > 0) {
                    hb = more.offset()
                        .top + more.outerHeight();
                }
            }

            rb = results.offset()
                .top + results.outerHeight();
            if (hb > rb) {
        ...
        countSelectableResults: function() {
            return this.results.find(".select2-result-selectable")
                .not(".select2-disabled")
                .length;
        },
        ...
        updateResults: function(initial) {
            ...
            if (search.val()
                .length < opts.minimumInputLength && checkFormatter(opts.formatInputTooShort, "formatInputTooShort")) {
...
this makes sure the search field is focussed even if the current event would blur it */
        ...
        selectHighlighted: function() {
            var index = this.highlight(),
                highlighted = this.results.find(".select2-highlighted")
                    .not(".select2-disabled"),
                data = highlighted.closest('.select2-result-selectable')
                    .data("select2-data");
            if (data) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function() {
            ...
            selection.bind("keydown", this.bind(function(e) {
                ...
                var keyWritten = String.fromCharCode(e.which)
                    .toLowerCase();
        ...
        postprocessResults: function(data, initial) {
            ...
            this.results.find(".select2-result-selectable")
                .each2(function(i, elm) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        addSelectedChoice: function(data) {
            var choice = $("<li class='select2-search-choice'>" + " <div></div>" + " <a href='#' onclick='return false;' class='select2-search-choice-close' tabindex='-1'></a>" + "</li>"),
                id = this.id(data),
                val = this.getVal(),
                formatted;
        ...
        postprocessResults: function() {
            ...
            compound.each2(function(i, e) {
                if (e.find(".select2-result-selectable")
                    .length == 0) {
