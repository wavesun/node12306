...
module.exports = function(userInfo, ticketInfo, token, ticketStr){
  ...
  */
  var postData = qs.stringify({
    ...
    "oldPassengers": userInfo.passenger_name + ",1," + userInfo.passenger_id_no,
    "passenger_1_seat": "M",
  ...
  var opt = {
    ...
    path: '/otsweb/order/confirmPassengerAction.do?method=confirmSingleForQueue',
    headers: headers,
    method: "POST",
  }
